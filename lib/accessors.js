...
*
* gtriu2tril( 2, 2, 0, A, 2, 1, 0, B, 2, 1, 0 );
* // B.data => [ 1.0, 0.0, 2.0, 4.0 ]
*/
function gtriu2tril( M, N, k, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB ) {
	var abuf;
	var bbuf;
	var aget;
	var bset;
	...
	if ( isRowMajor( [ strideA1, strideA2 ] ) ) {
		// Reflect row-by-row in order to ensure cache-optimal traversal...
		for ( i1 = 0; i1 < M; i1++ ) {
	...
	// Reflect column-by-column in order to ensure cache-optimal traversal...
	for ( i1 = 0; i1 < N; i1++ ) {
